...
graph LR
    ...
    subgraph Prism["🔮 AI Prism"]
        P["Prism"]
    end

    subgraph Lens1["🔭 External Lens"]
        B1["Open-Source Deep Dives"]
        B2["Architecture Analysis"]
        B3["Weekly Trending"]
    end

    subgraph Lens2["🤖 Internal Practice"]
    ...
    Input --> P
    P -->|"refraction #6366f1"| Lens1
    P -->|"refraction #ec4899"| Lens2

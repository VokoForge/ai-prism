...
graph LR
    ...
    subgraph Prism["🔮 AI Prism / AI 棱镜"]
        P["Prism<br/>棱镜"]
    end

    subgraph Lens1["🔭 External Lens / 外部视角"]
        B1["Open-Source Deep Dives<br/>开源深度解读"]
        B2["Architecture Analysis<br/>架构剖析"]
        B3["Weekly Trending<br/>周更热门"]
    end

    subgraph Lens2["🤖 Internal Practice / 内部实践"]
        C1["Agent Orchestration<br/>Agent 编排"]
        C2["Cost & Quality<br/>成本与质量"]
        C3["Team Culture<br/>团队文化"]
    end

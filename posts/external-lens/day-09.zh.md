...
> **为什么做对比.** 市面上 agent 框架超过 80 个. 我们在 6 个真实项目里用过其中 8 个, **每个都至少踩了 3 个坑**. 本文不讲 "hello world", 讲**真实项目里的工程权衡**.
...
> **评分公式:** (生产稳定 × 3) + (调试 × 2) + (性能 × 2) + (学习 × 1) + (团队规模 × 0.5)
...
*本文基于 6 个真实项目对 8 个框架的横评. 评分加权: 生产稳定 (3x) + 调试 (2x) + 性能 (2x) + 学习曲线 (1x) + 团队规模 (0.5x).*
